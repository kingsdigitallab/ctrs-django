...
DEFAULT_FROM_EMAIL = env(
    ...
    default="The community of the realm in Scotland, 1249–1424 <noreply@cotr.ac.uk>",
)
...
EMAIL_SUBJECT_PREFIX = env(
    ...
    default="[The community of the realm in Scotland, 1249–1424]"
)
...
LDAP_PROJECT_GROUP = f"cn=ctrs,{LDAP_BASE_OU}"
